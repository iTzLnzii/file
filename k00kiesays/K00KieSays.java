...
import org.example.duck.k00kiesays.GameManager.Commands.Locations.GameStartLocation;
import org.example.duck.k00kiesays.GameManager.Commands.Locations.LosingLocation;
import org.example.duck.k00kiesays.GameManager.Commands.Locations.OtherLocations;
...
import org.example.duck.k00kiesays.GameManager.Commands.Locations.WinningLocation;
...
public final class K00KieSays extends JavaPlugin {
    ...
    public static K00KieSays getPlugin()
    {
        return plugin;
    }
}
